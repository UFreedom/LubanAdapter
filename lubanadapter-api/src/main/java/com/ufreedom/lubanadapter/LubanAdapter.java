...
public class LubanAdapter {

    private static final String TAG = "LubanAdapter";
    ...
    public static IAdapterProxy inject(@NonNull Object target) {
        ...
        if (constructor == null) {
            throw new NullPointerException("Do Not find adapter proxy for " + targetClass.getName()
                    + ",Please check you have use @Holder or @Holders for you adapter");
        }
        try {
